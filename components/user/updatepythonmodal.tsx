...
export function UpdatePythonModal(props: any) {
  ...
  const handleUpload = () => {
    const storageRef = ref(storage, '/codes/python/main.py');
                      ...
                      <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                        <div className="text-center">
                          ...
                          <div className="mt-4 flex text-sm leading-6 text-gray-600">
                            ...
                            >
                              <span>{!file && "Python Datei hochladen"}{file && "Python Datei erfolgreich hochgeladen"}</span>
                          ...
                          <p className="text-xs leading-5 text-gray-600">.PY bis Maximal 10MB</p>
                        </div>
                      </div>
                    </div>
                  </div>
