                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <div className="relative mt-1 rounded-none shadow-sm">
                                <input
                                    type="email"
                                    {...register("email", { required: "Ihre E-Mail wird zur Registrierung benötigt." })}
                                    id="email"
                                    autoComplete="email"
                                    className="block w-full rounded-none border-gray-300 pl-2 pr-12 focus:border-green-600 focus:ring-green-600 sm:text-sm transition"
                                    placeholder="E-Mail"
                        ...
                        <div>
                            <div className="relative mt-1 rounded-none shadow-sm">
                                <Autocomplete apiKey={"AIzaSyAn_EqhijL1eXiZd_9Gp84tJub091O36CA"}
                                    id="address"
                            ...
                            {addressError && <p className="mt-2 text-sm text-red-600" id="email-error">Bitte wählen Sie eine valide Adresse aus (bestehend aus Straße, Hausnummer, Stadt und Land).</p>}
                        </div>
                    </div>
                    <div className="mt-2">
