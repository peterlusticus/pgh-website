        ...
        <div className="flex items-center justify-between py-6 md:justify-start md:space-x-10">
          <div className="flex justify-start lg:w-0 lg:flex-1">
            <Link href="/" className='flex space-x-2'>
              ...
              <div className='text-2xl font-bold'>PGH LICHTSTADT</div>
            </Link>
          </div>
          ...
          <div className="hidden items-center justify-end md:flex-1 md:flex lg:w-0">
            ...
            <Link href="/bookings/new">
              <button className='ml-2 text-white px-4 py-2 text-base font-medium rounded-none bg-red-900 hover:bg-red-700 transition'>
                Zum Konto
              </button>
            </Link>
          </div>
